...
test_that("test that info concatenation works", {
  ...
  expect_equal(get_info_message_concat(expr(NULL)), "")
  expect_equal(get_info_message_concat(quo(xyz)), "'xyz'")
  expect_equal(get_info_message_concat(expr(xyz)), "'xyz'")
  expect_equal(get_info_message_concat(exprs(a = xyz, abc)), "'xyz', 'abc'")
  expect_equal(get_info_message_concat(exprs(a = xyz, abc), include_names = TRUE), "'a'='xyz', 'abc'")
  expect_equal(get_info_message_concat(exprs(a = xyz, b = abc), include_names = TRUE, quotes = FALSE, names_sep = " -> "), "a -> xyz, b -> abc")
  expect_equal(get_info_message_concat(quos(a = xyz, b = abc), include_names = TRUE, quotes = FALSE, names_sep = " -> "), "a -> xyz, b -> abc")
})
