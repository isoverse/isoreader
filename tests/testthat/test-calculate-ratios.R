...
test_that("test that ratios can be calculated", {
  ...
  expect_equal(calculate_ratios(isofile, ratios = c("46/44"))$raw_data$`r46/44`, with(isofile$raw_data, v46.mV/v44.mV))
  ...
  isofiles_w_ratios <- calculate_ratios(isofiles, ratios = c("46/44", "45/44"))
