initialize_options <- function() {
  ...
  iso_register_dual_inlet_file_reader(".di.rds", "iso_load", "Isoreader R Data Structure", cacheable = FALSE, env = "isoreader")
  ...
  iso_register_continuous_flow_file_reader(".cf.rds", "iso_load", "Isoreader R Data Structure", cacheable = FALSE, env = "isoreader")
}
