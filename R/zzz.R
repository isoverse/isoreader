initialize_options <- function() {
  ...
  iso_register_dual_inlet_file_reader(".di.rds", "iso_read_rds", "Isoreader R Data Archive", cacheable = FALSE, env = "isoreader")
  ...
  iso_register_continuous_flow_file_reader(".cf.rds", "iso_read_rds", "Isoreader R Data Archive", cacheable = FALSE, env = "isoreader")
}
