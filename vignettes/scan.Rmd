...
iso_files %>% 
  iso_get_raw_data(
    ...
    select = c(x, units, v44.mV, v45.mV),
...
iso_files %>% iso_save("iso_files_export.scan.rds")

# read back the exported R data storage
iso_read_scan("iso_files_export.scan.rds") 
```
...
readxl::excel_sheets("iso_files_export.scan.xlsx")
```
